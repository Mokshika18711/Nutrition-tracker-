...
// MongoDB Connection
mongoose.connect(process.env.MONGO_URI || 'mongodb+srv://mokshika7777:mokshika123@cluster0.zgvfizf.mongodb.net/nutrition-tracker?retryWrites=true&w=majority')
...
app.get('/api/recipes', authMiddleware, async (req, res) => {
  ...
  db.recipes.insertMany([
  {
    ...
    instructions: ["Boil pasta", "Heat olive oil", "Add tomato sauce", "Mix and serve"]
  },
  {
    name: "Vegetable Stir Fry",
    ingredients: ["carrot", "broccoli", "soy sauce"],
    instructions: ["Chop vegetables", "Stir-fry in pan", "Add soy sauce", "Serve hot"]
  }
]);
});
